...
public final class VisitDimensionNormalizer {
    ...
    public static final int DEFAULT_MAX_DIM_VALUE_LEN = 255;
    public static final int DEFAULT_MAX_UA_RAW_LEN = 512;
    public static final int DEFAULT_MAX_TRACKING_VALUE_LEN = 128;
