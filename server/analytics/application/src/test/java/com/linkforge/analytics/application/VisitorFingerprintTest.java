...
class VisitorFingerprintTest {
    ...
    void fingerprint_should_be_deterministic_and_hex() {
        ...
        VisitContext v = new VisitContext("1.2.3.4", "ua-test");

        String f1 = VisitorFingerprint.fingerprint(day, v, "salt");
        String f2 = VisitorFingerprint.fingerprint(day, v, "salt");
        String f3 = VisitorFingerprint.fingerprint(day, new VisitContext("1.2.3.5", "ua-test"), "salt");
    ...
    void fingerprint_should_cap_user_agent_length() {
        ...
        VisitContext capped = new VisitContext("1.2.3.4", "a".repeat(512));
        VisitContext over = new VisitContext("1.2.3.4", longUa);
