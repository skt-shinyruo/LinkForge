...
public interface AnalyticsQueryMapper {
    ...
    List<AnalyticsTopLinkAggRow> topLinksOrderByPv(long tenantId, LocalDate from, LocalDate to, int limit);

    List<AnalyticsTopLinkAggRow> topLinksOrderByUv(long tenantId, LocalDate from, LocalDate to, int limit);
