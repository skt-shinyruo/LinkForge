 ...
 * 短链归档 V1 事件。
 *
 * <p>外层 {@code integration_events.event_type} 固定为 {@link ShortLinkEventTypes#SHORT_LINK_ARCHIVED_V1}；
 ...
 * @param snapshot 归档后的完整公开事实；其 {@code archivedAtUtc} 必须为非空 UTC 时间
 */
