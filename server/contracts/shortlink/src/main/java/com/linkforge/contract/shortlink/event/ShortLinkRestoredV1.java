 ...
 * 短链恢复 V1 事件。
 *
 * <p>外层 {@code integration_events.event_type} 固定为 {@link ShortLinkEventTypes#SHORT_LINK_RESTORED_V1}；
 ...
 * @param snapshot 恢复后的完整公开事实；其 {@code archivedAtUtc} 通常为 {@code null}
 */
