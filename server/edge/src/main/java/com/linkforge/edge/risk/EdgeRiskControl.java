package com.linkforge.edge.risk;
 ...
 */
@Component
public class EdgeRiskControl {

    private static final Logger log = LoggerFactory.getLogger(EdgeRiskControl.class);
    ...
    public EdgeRiskControl(AppProperties properties, RedisFixedWindowRateLimiter rateLimiter) {
