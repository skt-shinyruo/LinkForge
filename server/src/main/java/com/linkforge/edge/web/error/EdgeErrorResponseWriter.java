...
import com.linkforge.platform.web.RequestIdFilter;
...
@Component
public class EdgeErrorResponseWriter {

    private final ObjectMapper objectMapper;

    public EdgeErrorResponseWriter(ObjectMapper objectMapper) {
    ...
    public void write(
        ...
        EdgeErrorResponse body = new EdgeErrorResponse(errorCode.getCode(), message, requestId);
